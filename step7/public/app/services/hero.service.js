...
var HeroService = (function () {
    function HeroService(http, authService) {
        this.http = http;
        this.authService = authService;
        this.heroesUrl = 'https://bac-sunlight999.c9users.io/api/heroes'; // URL to web api
    }
    ...
    HeroService = __decorate([
        core_1.Injectable(), 
        __metadata('design:paramtypes', [angular2_jwt_1.AuthHttp, authentication_service_1.AuthenticationService])
    ], HeroService);
    return HeroService;
}());
